...
class DemoViewController: UIViewController {
    ...
    var imageset = [ #imageLiteral(resourceName: "images") , #imageLiteral(resourceName: "swami vivekanadna best motivationa thoughts in english-brainyteluguquotes") , #imageLiteral(resourceName: "MicrosoftTeams-image (46)") , #imageLiteral(resourceName: "cotact"), #imageLiteral(resourceName: "download (6)"), #imageLiteral(resourceName: "swami-vivekananda-inspire-wallpapers-download-21v1") , #imageLiteral(resourceName: "download (6)"), #imageLiteral(resourceName: "download (5)")]
